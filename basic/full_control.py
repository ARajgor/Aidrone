            ...
            for event in pygame.event.get():
                if event.type == pygame.USEREVENT + 1:
                    ...
                    if event.key == pygame.K_c:  # Edge detection
                        ...
                        recorder.start()
                        recorder.join()
                    if event.key == pygame.K_f:  # face detection
                        self.detection(frame_read)
                    if event.key == pygame.K_o:  # object detection
